...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="testNgXslt.networktype"/>
     <xsl:param name="testNgXslt.numberofreadings"/>
    ...
    <xsl:template match="/testng-results">
        ...
        <xsl:result-document href="{testng:absolutePath('overview.html')}" format="xhtml">
            <html xmlns="http://www.w3.org/1999/xhtml">
                ...
                <body>
                    <h2>
                    Complete Execution Report...<br/></h2>
                    ...
                    <xsl:choose>
                    <xsl:when test="contains($testNgXslt.networktype,'&#36;')">
                    </xsl:when>
                    <xsl:otherwise>
                    NetworkType  =
                    <xsl:value-of select="$testNgXslt.networktype" />
                    </xsl:otherwise>
                    </xsl:choose>
                    <br/>
                    ...
                    <xsl:choose>
                    <xsl:when test="contains($testNgXslt.numberofreadings,'&#36;')">
                    </xsl:when>
                    <xsl:otherwise>
                    NumberOfReadings  =
                    <xsl:value-of select="$testNgXslt.numberofreadings" />
                    </xsl:otherwise>
                    </xsl:choose>
                    <br/>
